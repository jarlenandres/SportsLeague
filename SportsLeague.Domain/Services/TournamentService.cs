...
public class TournamentService : ITournamentService
{
    ...
    public async Task<Tournament> CreateAsync(Tournament tournament)
    {
        ...
        _logger.LogInformation("Creating tournament: {TournamentName}",
            tournament.Name);
    ...
    public async Task<IEnumerable<Team>> GetTeamsByTournamentAsync(int tournamentId)
    {
        ...
        var tournamentTeams = await _tournamentTeamRepository.GetByTournametAsync(tournamentId);
    ...
    public async Task RegisterTeamAsync(int tournamentId, int teamId)
    {
        ...
        _logger.LogInformation("Registering team {TeamId} in tournament {TournamentId}", teamId, tournamentId);
    ...
    public async Task UpdateStatusAsync(int id, TournamentStatus newStatus)
    {
        ...
        _logger.LogInformation("Updating tournament {TournamentId} status to {NewStatus}", id, newStatus);

...
public class RefereeController : ControllerBase
{
    ...
    public RefereeController(IRefereeService refereeService, IMapper mapper, ILogger<RefereeController> logger)
    {
    ...
    {
        var referees = await _refereeService.GetAllAsync(); return Ok(_mapper.Map<IEnumerable<RefereeResponseDTO>>(referees));
    }
